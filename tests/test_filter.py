...
class CrispyFilterTests(SimpleTestCase):
    ...
    def test_crispy_filter(self):
        ...
        self.assertHTMLEqual(
            ...
            <label for="id_is_company" class="block text-content text-sm font-bold mb-2">company</label>
            <input type="checkbox" name="is_company" class="checkboxinput " id="id_is_company"> </div>

            <div id="div_id_email" class="mb-3">
            <label for="id_email" class="block text-content text-sm font-bold mb-2">email<span class="asteriskField">
            *</span> </label>
            <input type="text" name="email" maxlength="30" class="textinput textInput inputtext w-full rounded-lg """
            """border appearance-none py-2 border-gray-300 bg-white text-content focus:outline-none px-4 block """
            """leading-normal"
            required id="id_email">
            <small id="hint_id_email" class="text-gray-600">Insert your email</small> </div>

            <div id="div_id_password1" class="mb-3">
            <label for="id_password1" class="block text-content text-sm font-bold mb-2">password<span
            ...
            <label for="id_password2" class="block text-content text-sm font-bold mb-2">
            ...
            <label for="id_first_name" class="block text-content text-sm font-bold mb-2">
            ...
            """rounded-lg border appearance-none py-2 border-gray-300 bg-white text-content focus:outline-none """
            'px-4 block leading-normal"'
            """required id="id_first_name"> </div>

            <div id="div_id_last_name" class="mb-3">
            <label for="id_last_name" class="block text-content text-sm font-bold mb-2">
            ...
            """bg-white text-content focus:outline-none px-4 block leading-normal" required id="id_last_name"> """
            """</div>

            <div id="div_id_datetime_field" class="mb-3">
            <label for="id_datetime_field_0" class="block text-content text-sm font-bold mb-2">
            ...
            """text-content focus:outline-none px-4 leading-normal" required id="id_datetime_field_0">
            <input type="text" name="datetime_field_1" class="timeinput rounded-lg focus:outline border """
            """appearance-none py-2 mr-2 border-gray-300 bg-white text-content focus:outline-none px-4 """
            """leading-normal" required id="id_datetime_field_1"> </div>

            <div id="div_id_tos_accepted" class="mb-3">
            <label for="id_tos_accepted" class="block text-content text-sm font-bold mb-2">
            ...
            """appearance-none leading-normal text-content" name="tos_accepted">
            <option value="accepted">Accepted</option>
            <option value="not_accepted">Not accepted</option>
            </select><div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-content">
        ...
        expected_html = """
            ...
            <div class="multiField">
                <div id="div_id_form-0-name" class="mb-3">
                    <label for="id_form-0-name" class="block text-content text-sm font-bold mb-2"> Name<span class="asteriskField">*</span> </label>
                    <input
                        type="text"
                        name="form-0-name"
                        maxlength="3"
                        class="textinput textInput inputtext focus:outline-none block appearance-none px-4 border-gray-300 bg-white py-2 leading-normal text-content border rounded-lg w-full"
                        id="id_form-0-name"
                    />
                </div>
            </div>
            ...
            <div class="multiField">
                <div id="div_id_form-1-name" class="mb-3">
                    <label for="id_form-1-name" class="block text-content text-sm font-bold mb-2"> Name<span class="asteriskField">*</span> </label>
                    <input
                        type="text"
                        name="form-1-name"
                        maxlength="3"
