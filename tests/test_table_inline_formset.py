            ...
            <tbody>
                <tr>
                    ...
                    <td id="div_id_form-0-email" class="border px-4 py-2">
                        <input
                            ...
                            name="form-0-email"
                            maxlength="30"
                            class="textinput textInput inputtext w-full border border-gray-300 focus:outline-none text-content px-4 bg-white leading-normal rounded-lg block py-2 appearance-none"
                            id="id_form-0-email"
                        />
                    ...
                    <td id="div_id_form-0-password1" class="border px-4 py-2">
                        <input
                            ...
                            maxlength="30"
                            class="passwordinput w-full border border-gray-300 focus:outline-none text-content px-4 bg-white leading-normal rounded-lg block py-2 appearance-none"
                    ...
                    <td id="div_id_form-0-datetime_field" class="border px-4 py-2">
                        <input
                            ...
                            class="dateinput border border-gray-300 text-content focus:outline-none px-4 mr-2 bg-white focus:outline leading-normal rounded-lg py-2 appearance-none"
                            id="id_form-0-datetime_field_0"
                        />
                        <input
                            type="text"
                            name="form-0-datetime_field_1"
                            class="timeinput border border-gray-300 text-content focus:outline-none px-4 mr-2 bg-white focus:outline leading-normal rounded-lg py-2 appearance-none"
                    ...
                    <td id="div_id_form-0-tos_accepted" class="border px-4 py-2">
                        <div class="border px-4 py-2">
                            <div class="relative">
                                <select class="bg-white focus:outline-none border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal text-content" name="form-0-tos_accepted">
                ...
                <tr>
                    ...
                    <td id="div_id_form-1-tos_accepted" class="border px-4 py-2">
                        <div class="border px-4 py-2">
                            <div class="relative">
                                <select class="bg-white focus:outline-none border border-gray-300 rounded-lg py-2 px-4 block w-full appearance-none leading-normal text-content" name="form-1-tos_accepted">
                                    <option value="accepted">Accepted</option>
                                    <option value="not_accepted">Not accepted</option>
                                </select>
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-content">
    ...
    def test_failing_table_inline_formset(self):
        ...
        <form method="post">
            ...
            <table class="table-auto">
                ...
                <tbody>
                    <tr>
                        <td id="div_id_name-0-name" class="border px-4 py-2"> <input type="text" name="name-0-name" value="test" maxlength="3" class="textinput textInput inputtext bg-white px-4 w-full appearance-none border py-2 focus:outline-none border-red-500 block rounded-lg leading-normal text-content" id="id_name-0-name">
                    ...
                    <tr>
                        <td id="div_id_name-1-name" class="border px-4 py-2"> <input type="text" name="name-1-name" maxlength="3" class="textinput textInput inputtext bg-white px-4 w-full appearance-none border py-2 focus:outline-none border-gray-300 block rounded-lg leading-normal text-content" id="id_name-1-name">                    </td>
                    </tr>
                    <tr>
                        <td id="div_id_name-2-name" class="border px-4 py-2"> <input type="text" name="name-2-name" maxlength="3" class="textinput textInput inputtext bg-white px-4 w-full appearance-none border py-2 focus:outline-none border-gray-300 block rounded-lg leading-normal text-content" id="id_name-2-name">                    </td>
                    </tr>
                </tbody>
            </table>
            <div class="mt-3">
