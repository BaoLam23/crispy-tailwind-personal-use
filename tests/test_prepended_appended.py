                ...
                <div class="">
                    <div class="flex">
                        ...
                        <input
                            ...
                            name="first_name"
                            maxlength="5"
                            class="textinput textInput inputtext border border-gray-300 rounded-lg rounded-l-none px-4 py-2 w-full focus:outline-none text-content border-l-0 leading-normal"
                            required
                            id="id_first_name"
                        />
                    </div>
            ...
            <div id="div_id_first_name" class="mb-3">
                ...
                <div class="">
                    <div class="flex">
                        ...
                        <input type="text" name="first_name" maxlength="5" class="textinput textInput inputtext border border-gray-300 px-4 py-2 w-full focus:outline-none text-content border-r-0 leading-normal" required id="id_first_name" />
                        <span class="border rounded-lg border-gray-300 rounded-l-none px-3 bg-gray-200 text-gray-800 flex items-center">.com</span>
                    </div>
                </div>
            </div>
            ...
            <div id="div_id_name" class="mb-3">
                <div class="">
                    <div class="flex">
                        ...
                        <input type="text" name="name" class="textinput textInput inputtext border border-red-500 rounded-lg rounded-l-none px-4 py-2 w-full focus:outline-none text-content border-l-0 leading-normal" required id="id_name" />
                    </div>
                </div>
    ...
    def test_appended_with_errors(self):
        ...
        expected_html = """
            <div id="div_id_name" class="mb-3">
                <div class="">
                    <div class="flex">
                        <input type="text" name="name" class="textinput textInput inputtext border border-red-500 rounded-lg rounded-r-none px-4 py-2 w-full focus:outline-none text-content border-r-0 leading-normal" required id="id_name" />
        ...
        expected_html = """
            <div id="div_id_name" class="mb-3">
                <div class="">
                    <div class="flex">
                        <span class="border-red-500 border-r-0 border rounded-lg rounded-r-none px-3 bg-gray-200 text-gray-800 flex items-center">@</span>
                        <input type="text" name="name" class="textinput textInput inputtext border border-r-0 border-l-0 border-red-500 px-4 py-2 w-full focus:outline-none text-content border-r-0 leading-normal" required id="id_name" />
